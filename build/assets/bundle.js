  ...
  function Modal(modal) {
    ...
    _defineProperty(this, "openModal", function (evt) {
      ...
      if (evt.currentTarget.dataset.modalAnchor === 'staff-card') {
        ...
        var staffPhoto = _this.modal.querySelector('.staff-card img');

        staffPhoto.setAttribute('src', '');
        staffPhoto.setAttribute('alt', '');

        var staffName = _this.modal.querySelector('.staff-card__title');

        staffName.innerHtml = '';

        var staffDesc = _this.modal.querySelector('.staff-card__desc');

        staffDesc.innerHtml = '';

        var staffList = _this.modal.querySelector('.staff-card__list');

        staffList.querySelectorAll('li').forEach(function (el) {
          return el.remove();
        });
        /*Обнуляю все записи*/
        ...
        var img = parentNode.parentNode.querySelector('.staff-card img');
        var name = parentNode.querySelector('.staff-card__title');
        var desc = parentNode.querySelector('.staff-card__desc');
        ...
        var template = parentNode.querySelector('#staff-card-full-description');
...
var titles = document.querySelectorAll('.js-content-menu-item');

if (titles) {
  var menu = document.querySelector('.content-menu__list:first-child');
  titles.forEach(function (title, index) {
    ...
    link.setAttribute('href', "#".concat(index));
  ...
  var onClickScrollToAnchor = function onClickScrollToAnchor(evt) {
    ...
    var anchor = document.querySelector(".js-content-menu-item[data-id=\"".concat(target.dataset.id, "\"]"));
    var topOffset = document.querySelector('.info-block').offsetTop;
    var headerOffset = document.querySelector('.main-header__section--bottom').offsetTop;
  ...
  var onScrollSetActiveItem = function onScrollSetActiveItem() {
    titles.forEach(function (title, index) {
      if (gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__.ScrollTrigger.isInViewport(title.closest('section'))) {
  ...
  var links = document.querySelectorAll('.content-menu__list-item a');
...
if (galleries) {
  galleries.forEach(function (gallery) {
    ...
    items.forEach(function (item) {
      ...
      var caption = item.parentNode.parentNode.querySelector('[data-fancybox-caption]');
...
var heroSlider = document.querySelector('.hero-section-swiper');
...
if (clientsSlider) {
  new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](clientsSlider, {
...
var featureCardSlider = document.querySelector('.feature-card-slider');

if (featureCardSlider) {
  new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](featureCardSlider, {
    slidesPerView: 'auto',
    spaceBetween: 10
  });
}
...
/***/ "./src/scripts/modules/team-preview-grid.js":
/*!**************************************************!*\
  !*** ./src/scripts/modules/team-preview-grid.js ***!
  \**************************************************/
/***/ (() => {
...
if (cards.length) {
  ...
  var onClickShowItems = function onClickShowItems() {
    showItems();
  ...
  var hideItems = function hideItems() {
    ...
    cards.forEach(function (card, index) {
      if (index + 1 > CARDS_TO_SHOW) {
        !card.classList.contains('hidden') ? card.classList.add('hidden') : null;
      }
    });
...
/* harmony import */ var _modules_modernizr__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/modernizr */ "./src/scripts/modules/modernizr.js");
/* harmony import */ var _modules_modernizr__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_modules_modernizr__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var _modules_imask__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_modules_imask__WEBPACK_IMPORTED_MODULE_2__);
...
/* harmony import */ var _modules_content_menu__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/content-menu */ "./src/scripts/modules/content-menu.js");
/* harmony import */ var _modules_team_preview_grid__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/team-preview-grid */ "./src/scripts/modules/team-preview-grid.js");
/* harmony import */ var _modules_team_preview_grid__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_modules_team_preview_grid__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _modules_team_tabs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/team-tabs */ "./src/scripts/modules/team-tabs.js");
/* harmony import */ var _modules_team_tabs__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_modules_team_tabs__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _modules_wrappers__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/wrappers */ "./src/scripts/modules/wrappers.js");
/* harmony import */ var _modules_wrappers__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_modules_wrappers__WEBPACK_IMPORTED_MODULE_7__);
...
/* harmony import */ var _modules_common__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/common */ "./src/scripts/modules/common.js");
/* harmony import */ var _modules_common__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(_modules_common__WEBPACK_IMPORTED_MODULE_9__);
/* harmony import */ var _modules_fancybox__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/fancybox */ "./src/scripts/modules/fancybox.js");
